...
const TaskElement: React.FC<IProps> = ({text})=> {
  ...
  return <div className={styles.column}>
    <div className={taskDone} onClick={()=>{
      taskDone=== styles.column__checkbox ? setTaskDone(styles.column__checkbox +' '+ styles.column__checkboxDone ) : setTaskDone(styles.column__checkbox)
      textDone=== styles.column__text ? setTextDone(styles.column__text +' '+ styles.column__textDone ) : setTextDone(styles.column__text)

    }}/>
    <p className={textDone}>{text}</p>
    <svg className={styles.column__svg} width="16" height="17" viewBox="0 0 16 17" fill="none"
